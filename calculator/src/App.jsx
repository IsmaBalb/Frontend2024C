        ...
        <td className='text-end' colSpan={4}>
          <h2>0</h2>
           ...
           <tr>
            <td>
            <button
                className={operatorButtonsClasses} type= 'button'>7</button>
            </td>
            <td>
            <button
                className={operatorButtonsClasses} type= 'button'>8</button>
            </td>
            <td>
            <button
                className={operatorButtonsClasses} type= 'button'>9</button>
            </td>
            <button
